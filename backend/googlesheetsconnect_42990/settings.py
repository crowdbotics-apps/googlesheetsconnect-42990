"""
Django settings for googlesheetsconnect_42990 project.
...
ROOT_URLCONF = 'googlesheetsconnect_42990.urls'
...
WSGI_APPLICATION = 'googlesheetsconnect_42990.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "googlesheetsconnect_42990 API",
    "DESCRIPTION": "API documentation for googlesheetsconnect_42990 App",
    "VERSION": "v1",
}
