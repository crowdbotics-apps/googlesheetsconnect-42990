...
## Project Structure
    ...
    ├── googlesheetsconnect_42990  # Django project configurations
...
1. Clone this repo and `cd googlesheetsconnect_42990`
...
2. Clone this repo and `cd googlesheetsconnect_42990`
